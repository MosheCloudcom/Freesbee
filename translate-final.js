...
document.currentScript.style.textAlign = 'right';
    ...
    if (copyLinkTitleElement) {
        ...
        copyLinkTitleElement.innerText = "לחץ להעתקת הקישור להמשך מילוי שליחת הטופס";
    } else {
...
// Check for the existence of the target element every 2000 milliseconds
var checkInterval = setInterval(checkElement, 2000);
